...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("08c9f210", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-308c3445\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./InventoryForm.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-308c3445\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./InventoryForm.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ImagesComponent__ = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ttl__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__BrandComp__ = __webpack_require__(157);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Categories_CategoryComp__ = __webpack_require__(163);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submit: function submit() {
            ...
            axios.post('/inventories', image).then(function (res) {
                console.log(res);
            }).catch(function (err) {
                console.log(err);
            });
    ...
    watch: {
        rootCat: function rootCat() {
            ...
            axios.get('/levelonecategories').then(function (response) {
                _this2.levelOneArr = response.data;
                console.log(response.data);
            }).catch(function (errors) {
                console.log(errors);
            });
        ...
        levelOneCat: function levelOneCat() {
            ...
            axios.get('/leveltwocategories').then(function (response) {
                _this3.levelTwoArr = response.data;
                console.log(response.data);
            }).catch(function (errors) {
                console.log(errors);
            });
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "headline" }, [
            _vm._v("Brand / Company Product Upload Form")
          ])
        ]
      ),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-308c3445", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-308c3445"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/forms/InventoryForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-308c3445", Component.options)
  } else {
    hotAPI.reload("data-v-308c3445", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
