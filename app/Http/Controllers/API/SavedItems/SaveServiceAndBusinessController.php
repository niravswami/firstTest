...
class SaveServiceAndBusinessController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($user) {
            ...
            $user->serviceandbusinesses()->sync($request->prd_id, false);

            $hasProduct = $user->serviceandbusinesses()->where('service_and_business_id', $request->prd_id)->exists();
    ...
    public function show($id)
    {
        ...
        if($user)
        {
            ...
            $hasProduct = $user->serviceandbusinesses()->where('service_and_business_id', $id)->exists();
    ...
    public function destroy($id)
    {
        ...
        if($user)
        {
            $user->serviceandbusinesses()->detach($id);
