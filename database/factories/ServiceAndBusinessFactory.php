...
$factory->define(App\ServiceAndBusiness\ServiceAndBusiness::class, function (Faker $faker) {
    ...
    $values = array();
        ...
        $values []= $faker->imageUrl($width = 400, $height = 400, 'nature', true, 'Faker');
        }
    ...
    return [
        ...
        'category_id' => function() {
            return ServiceAndBusinessCategory::all()->random();
        },

        'image' => $faker->imageUrl($width = 400, $height = 400, 'nature', true, 'Faker'),
